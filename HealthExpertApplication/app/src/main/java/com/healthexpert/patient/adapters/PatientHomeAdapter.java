...
public class PatientHomeAdapter extends RecyclerView.Adapter<PatientHomeAdapter.NewsFeedViewHolder> {

    ArrayList<String> data;
    private LikeItemUpdateListener commander;

    public PatientHomeAdapter(ArrayList<String> data, LikeItemUpdateListener commander) {
        this.data = data;
    ...
    @Override
    public PatientHomeAdapter.NewsFeedViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final PatientHomeAdapter.NewsFeedViewHolder holder, final int position) {
