...
public class MyPatientsAdapter extends RecyclerView.Adapter<MyPatientsAdapter.NewsFeedViewHolder> {

    private ArrayList<Patient> data;
    private LikeItemUpdateListener commander;

    public MyPatientsAdapter(ArrayList<Patient> data, LikeItemUpdateListener commander) {
        this.data = data;
    ...
    @Override
    public MyPatientsAdapter.NewsFeedViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
