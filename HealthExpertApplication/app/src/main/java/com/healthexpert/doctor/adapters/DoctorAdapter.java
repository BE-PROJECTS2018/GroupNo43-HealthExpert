...
public class DoctorAdapter extends RecyclerView.Adapter<DoctorAdapter.NewsFeedViewHolder> {

    ArrayList<DoctorResponse> data;
    private LikeItemUpdateListener commander;
    BaseButton bCall;

    public DoctorAdapter(ArrayList<DoctorResponse> data, LikeItemUpdateListener commander) {
        this.data = data;
    ...
    public interface LikeItemUpdateListener {
        ...
        void onChatClicked(DoctorResponse doctorResponse);
    }

    @Override
    public DoctorAdapter.NewsFeedViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_doctors, parent, false);
        NewsFeedViewHolder holder = new NewsFeedViewHolder(v);
        return holder;
    }

    @Override
    public void onBindViewHolder(final DoctorAdapter.NewsFeedViewHolder holder, final int position) {
    ...
    public class NewsFeedViewHolder extends RecyclerView.ViewHolder {
        ...
        BaseTextView tvName, tvSpeciality, tvExp, tvLikes, tvRating, tvPhoneno;
        LinearLayout llItem;
        ...
        public NewsFeedViewHolder(final View itemView) {
            ...
            bCall = (BaseButton) itemView.findViewById(R.id.bChat);
            ...
            bCall.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (commander != null) {
                        commander.onChatClicked(data.get(getAdapterPosition()));
                    }
                }
            });
