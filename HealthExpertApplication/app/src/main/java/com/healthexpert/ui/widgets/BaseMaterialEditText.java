...
public class BaseMaterialEditText extends MaterialEditText {
    public BaseMaterialEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        applyCustomFont(context, attrs);
    }

    public BaseMaterialEditText(Context context, AttributeSet attrs, int defStyle) {
