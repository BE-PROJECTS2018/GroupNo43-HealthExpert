...
with open("raw/dirty_dataset.csv") as csvfile:
...
with open("clean_dataset.csv", "wt", encoding='utf-8', newline='') as csvfile:
...
slist = []
dlist = []
with open("nodetable.csv", "wt", encoding='utf-8', newline='') as csvfile:
    writer = csv.writer(csvfile)
